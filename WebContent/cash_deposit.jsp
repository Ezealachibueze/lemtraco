...
statement=connection.prepareStatement("select * from lemtraco_temporary_package  where userid = '"+c+"' limit 1");
...
<center  style="background: #fff">
		...
		<tr>
		<td>
		  <label  class="cus">Investment Unit:  </label>  <input    style=" background: #fff; "  type="text"  class="e3" name="total"         value="<%=resultSet.getString("token") %>"   readonly="readonly" />
